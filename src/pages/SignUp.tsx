    ...
    >
      ...
      >
        ...
        <div className="py-5 flex flex-col gap-2 justify-center items-center max-lg:w-full">
          ...
          <div className="flex flex-col gap-2 max-lg:w-full">
            ...
            <select
              ...
              className="w-[450px] h-[47px] p-2 text-black focus:outline-none rounded-md max-lg:w-full cursor-pointer"
            >
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className="bg-black/80 w-[250px] h-[47px] hover:bg-black/70 max-lg:bg-black/50"
          >
            Next
          </button>
        </div>
