...
const Courses = () => {
  return (
    <section className="max-lg:px-5 h-full w-full bg-primarywhite px-16 py-20 flex justify-center items-center font-jarkata">
      <div className="flex justify-center items-center max-lg:w-full flex-col">
        ...
        <div className="max-lg:w-[500px]">
          <img src={wip} alt="Work in Progress" className="w-full h-full" />
        </div>
      </div>
    </section>
  );
